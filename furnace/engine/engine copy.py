...
class Engine(object):
    ...
    def inject_default_parser(self):
        ...
        p.add_argument('-d', '--devices', default='',
                       help='set data parallel training') # default 原本是 ''
        ...
        p.add_argument("-m", "--mix", type=str, choices=['mixup','cutout','cutmix','mosaic','ricap','classmix'], 
                       default='classmix', help='mixed sample data augmentation methods')
