...
C.visual_img_dir = C.abs_dir + '/visual'
...
''' Experiments Setting '''
C.labeled_ratio = 8 # 8 16    # ratio of labeled set
print("---------Ratio--------{}".format(C.labeled_ratio))
...
C.num_workers = 8
C.train_scale_array =[0.5, 0.75, 1, 1.5, 1.75, 2.0]## [1] 
C.warm_up_epoch = 0
